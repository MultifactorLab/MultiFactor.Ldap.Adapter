    ...
    public class StartupLogger
    {
        ...
        private static readonly Lazy<Logger> _logger = new Lazy<Logger>(() =>
        {
            ...
            if (string.IsNullOrWhiteSpace(baseDir))
                throw new NullReferenceException("Base directory is null");
        ...
        public static void Error(Exception ex, string message, params object[] values) =>
            _logger.Value.Error(ex, message, values);
    }
}